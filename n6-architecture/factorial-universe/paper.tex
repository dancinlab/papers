...
\texttt{https://github.com/dancinlab}}
...
All analyses are available at \url{https://github.com/dancinlab/papers} with one-click reproduction via \texttt{run\_all.sh}. The SEDI analysis engine (42,580 lines, 74 data source modules) is open-source at \url{https://github.com/dancinlab/sedi}.
